...
long long countInterestingPairs(vector<int>& a, long long x, long long y, int n) {
    sort(a.begin(), a.end());
    ...
    for (int i = 0; i < n; ++i) {
        // Use lower_bound and upper_bound to find valid pairs
...
void solve() {
    ...
    vector<int> a;
    readArray(a,n);
    ll ans = countInterestingPairs(a, x, y, n);
    print(ans);
